...
from tkinter import *               #Tkinter per la creazione dell'interfaccia grafica
from tkinter import ttk, messagebox #Componenti aggiuntive della libreria Tkinter
from datetime import datetime       #Datetime per la gestione di date e orari
import locale                       #Locale per impostare nella lingua italiana datetime
import requests                     #Requests Per eseguire richieste HTTP alle API di Unsplash e OpenWeather
import sqlite3                      #SQLite per interagire con il database
import io                           #Io e BytesIO per gestire i dati di tipo byte
from io import BytesIO               
from urllib.request import urlopen  #Urllib e urlopen per aprire URL e scaricare immagini.
from PIL import Image, ImageTk      #Image, ImageTk da PIL (libreria Pillow) per lavorare con immagini e visualizzarle in Tkinter.
...
sfondo = PhotoImage(file='img/sfondo_app.png')
label_sfondo = Label(finestra, image=sfondo)

# Immagine della citta'
default = PhotoImage(file='img/default.png')
...
button_find_city_weather = PhotoImage(file='img/button_find_city_weather.png')
...
# Icona meteo
icona_meteo_default = PhotoImage(file='img/default_icon.png')
...
button_mostra_database = PhotoImage(file='img/button_mostra_database.png')
...
button_delete = PhotoImage(file='img/button_delete.png')
...
button_indietro = PhotoImage(file='img/button_indietro.png')
